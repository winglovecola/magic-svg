...
import { Circle, Rectangle, Square, Triangle } from './svg.js';
...
describe('Square', () => {
    ...
    describe('render', () => {
      it('Render square svg element and output the correct attributes accordingly', () => {
        
        const shape = new Square("blue", 10, 10, 200, "black", 1);

        expect(shape.render()).toEqual('<rect x="10" y="10" width="200" height="200" stroke="black" stroke-width="1" fill="blue" />');
      });
    });
  });
